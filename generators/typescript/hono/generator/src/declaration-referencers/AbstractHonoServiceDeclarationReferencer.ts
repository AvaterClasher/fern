...
export declare namespace AbstractHonoServiceDeclarationReferencer {
    export interface Init extends AbstractDeclarationReferencer.Init {
        packageResolver: PackageResolver;
    }
}

export abstract class AbstractHonoServiceDeclarationReferencer<Name> extends AbstractDeclarationReferencer<Name> {
    protected packageResolver: PackageResolver;

    constructor({ packageResolver, ...superInit }: AbstractHonoServiceDeclarationReferencer.Init) {
        super(superInit);
