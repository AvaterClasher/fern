...
export interface ServiceServiceMethods {
    getDirectThread(
        req: {},
        res: {
            send: (responseBody: SeedAudiences.folderD.Response) => Promise<void>;
...
export class ServiceService {
    ...
    public toHono(): Hono {
        this.app.get("", async (c) => {
            try {
                let _responseBody: SeedAudiences.folderD.Response | undefined;
                const _cookies: {
                    name: string;
                    value: string;
                ...
                return c.json(
                    serializers.folderD.Response.jsonOrThrow(_responseBody, { unrecognizedObjectKeys: "strip" }),
                    200,
                );
            } catch (error) {
