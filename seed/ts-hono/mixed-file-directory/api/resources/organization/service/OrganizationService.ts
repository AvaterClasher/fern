...
export interface OrganizationServiceMethods {
    ...
    create(
        req: {
            body: SeedMixedFileDirectory.CreateOrganizationRequest;
        },
        res: {
...
export class OrganizationService {
    ...
    public toHono(): Hono {
        this.app.post("/", async (c) => {
            const request = serializers.CreateOrganizationRequest.parse(await c.req.json());
            if (request.ok) {
                try {
                    let _responseBody: SeedMixedFileDirectory.Organization | undefined;
                    const _cookies: {
                        name: string;
                        value: string;
