...
export class MetadataService {
    ...
    public toHono(): Hono {
        this.app.get("/", async (c) => {
            try {
                let _responseBody: SeedMixedFileDirectory.user.events.Metadata | undefined;
                const _cookies: {
                    name: string;
                    value: string;
                ...
                return c.json(
                    serializers.user.events.Metadata.jsonOrThrow(_responseBody, { unrecognizedObjectKeys: "strip" }),
                    200,
                );
            } catch (error) {
